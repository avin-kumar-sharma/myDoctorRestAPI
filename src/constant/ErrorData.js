...
export const ErrorData = {
	ERROR_STATUS_ARRAY: [
		...
		},
		{
			status: "408",
			message:
				"Verification code was valid for 24 hours, Please click on resend.",
		...
		},
		{
			...
			data: "Patient with ID present in appointment request is not found.",
		},
		{
			status: "419",
			message: "Failed to book appointment.",
			data: "Doctor with ID present in appointment request is not found.",
		},
		{
			status: "420",
			message: "Failed to register new user.",
			data: "This mobile number is already registered.",
		},
		{
			status: "421",
			message: "Failed to register new user.",
